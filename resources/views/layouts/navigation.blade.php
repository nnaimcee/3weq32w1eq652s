        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('outbound.create')" :active="request()->routeIs('outbound.create')">
                        {{ __('📤 เบิกของออก') }}
                    </x-nav-link>

                    <x-nav-link :href="route('transfer.create')" :active="request()->routeIs('transfer.create') || request()->routeIs('transfer.pending')">
                        {{ __('🚚 ย้ายตำแหน่ง') }}
                    </x-nav-link>
