...
- **🔐 ระบบจัดการสิทธิ์ผู้ใช้งาน (Role-based Access Control)**
  - `Admin`: เข้าถึงได้ทุกฟังก์ชัน (จัดการผู้ใช้งาน, เพิ่ม/ลบสินค้า, จัดการสถานที่, จอง/ปลดจอง, ลบสต็อก)
...
- **📦 การจัดการสินค้าคงคลัง (Inventory Management)**
  ...
  - รองรับระบบ สินค้าแบบล็อต (Lot ID & Lot Number) และระบบเข้าก่อนออกก่อน (FIFO)
  - ค้นหาสินค้าแบบ Dynamic Search ทันทีเมื่อพิมพ์
...
- **📍 การจัดการสถานที่ (Location & Zone Management)**
  ...
  - แผนผังคลังสินค้า (Warehouse Map) แบบ Visual แสดงจุดสถานะ (มีสินค้า 🔵, จอง 🟡, ว่าง 🟢, เต็ม 🟧, ปิดใช้งาน 🔴)
  - กำหนดสถานะพื้นที่ (Active / Inactive / Full)
  - ค้นหาสถานที่จัดการแบบ Dynamic Search พร้อมระบบแบ่งหน้า (Pagination)

- **🔄 ระบบจัดการธุรกรรม (Transactions)**
  - **Inbound (รับเข้า):** สแกนรับของเข้าคลัง ระบุ Lot ID ด้วยตัวเองหรือสร้างอัตโนมัติได้
  - **Outbound (เบิกออก):** เบิกของออกตามระบบ FIFO โดยอัตโนมัติ
  - **Transfer (ย้ายสถานที่):** ย้ายสินค้าข้ามโซน โดยมีการรอรับเข้า (Transit) และบันทึกชื่อผู้รับของในประวัติชัดเจน
